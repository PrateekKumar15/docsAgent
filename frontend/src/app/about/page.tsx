  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center flex-1 py-20 px-4 sm:px-6 lg:px-8 bg-neutral-950 text-neutral-100 min-h-screen">
        ...
        >
          <Card className="w-full max-w-3xl p-8 sm:p-10 md:p-12 bg-neutral-900/80 border-neutral-700/60 shadow-xl rounded-xl flex flex-col items-center text-center m-10">
            <motion.h1
